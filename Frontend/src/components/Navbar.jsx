...
const Navbar = () => {
  return (
    <nav className="bg-white light:bg-gray-900 sticky top-0 w-full z-20 border-b border-gray-200 light:border-gray-600 text-lg font-bold">
      <div className="max-w-screen-xl h-[90px] flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          <button
            type="button"
            className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 light:bg-green-600 light:hover:bg-green-700 light:focus:ring-green-800"
          >
            Log out
          </button>
          <button
